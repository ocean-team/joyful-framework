...
public class DateFormatUtil {
     ...
     *
     * endDate必须大于starDate,间隔时间可大于一天
     */
    public static String formatDuration(@NotNull Date startDate, @NotNull Date endDate) {
        return DurationFormatUtils.formatDurationHMS(startDate.getTime() - endDate.getTime());
    }
    ...
    /**
     *按HH:mm:ss的格式，格式化时间间隔
     *
     * endDate必须大于startDate，间隔可大于一天
     */
    public static String formatDurationOnSecond(@NotNull Date startDate, @NotNull Date endDate) {
        return DurationFormatUtils.formatDuration(startDate.getTime() - endDate.getTime(), "HH:mm:ss");
    }
    ...
    public static String formatFriendlyTimeSpanByNow(long timeStampMillis) {
        ...
        // 获取当天00:00
        long wee = DateUtil.beginOfDate(new Date()).getTime();
